...
const Topbar = ({
    ...
    const renderMenuNotification = (
        ...
        >
            ...
            >
                <Grid item xs={12} md={12} sx={{ display: "flex" }}>
                    <Button sx={{ textTransform: 'capitalize', width: '100%', justifyContent: 'flex-start' }}>
                        <Avatar>
                            <PestControlIcon />
                        </Avatar>
                                                ...
                                                return menu.hasSubItems ? (
                                                    <div>
                                                        <Button
                                                            ...
                                                            aria-haspopup="true"
                                                            aria-expanded={
                                                                openMenus.includes(menu.id) ? "true" : undefined
                                                            }
                                                        ...
                                                        <Menu
                                                            ...
                                                            anchorEl={
                                                                openMenus.includes(menu.id)
                                                                    ? document.getElementById(`${menu.id}-button`)
                                                                    : null
                                                            }
